...
void BS_tree<tkey, tvalue, compare, t>::erase_from_leaf(std::stack<std::pair<bstree_node**,size_t>>&path, size_t index) {
    ...
    throw std::logic_error("The node doesn't have any brothers and it isn't a root");
}
